...
def main():
    ...
    for m in MODULES:
        all_fails += m.run()
        for extra in ('run_trust', 'run_settings', 'run_locations', 'run_phone', 'run_handler_order', 'run_daily_once', 'run_empty_restore', 'run_etag', 'run_standalone', 'run_upgrade_existing', 'run_cost_required'):
            if hasattr(m, extra):
